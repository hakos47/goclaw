...
func (l *Loop) buildMessages(ctx context.Context, runID string, history []providers.Message, summary, userMessage, extraSystemPrompt, sessionKey, channel, channelType, chatTitle, chatID, peerKind, userID string, historyLimit int, skillFilter []string, lightContext bool) ([]providers.Message, bool) {
	...
	toolNames := l.filteredToolNamesForChannel(runID, channelType)
	if !l.skillEvolve {
