-- Migration 000063_embedding_dimension_1024.down.sql
...
-- 2. Clear existing embeddings (USING NULL) to avoid casting errors and change dimension back to 1536
ALTER TABLE skills ALTER COLUMN embedding TYPE vector(1536) USING NULL;
ALTER TABLE agents ALTER COLUMN embedding TYPE vector(1536) USING NULL;
ALTER TABLE memory_chunks ALTER COLUMN embedding TYPE vector(1536) USING NULL;
ALTER TABLE vault_documents ALTER COLUMN embedding TYPE vector(1536) USING NULL;
ALTER TABLE team_tasks ALTER COLUMN embedding TYPE vector(1536) USING NULL;
ALTER TABLE kg_entities ALTER COLUMN embedding TYPE vector(1536) USING NULL;
ALTER TABLE episodic_summaries ALTER COLUMN embedding TYPE vector(1536) USING NULL;
ALTER TABLE embedding_cache ALTER COLUMN embedding TYPE vector(1536) USING NULL;
